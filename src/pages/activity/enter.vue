    ...
    <div v-show="ruleShow" class="rule">
      ...
      <div class="rule-pannel">
        ...
        <div class="rule-content">
          ...
          <p class="rule-desc-content">1．参与用户必须在线签订电子协议，凭借身份证参于本场活动。</p>
          ...
          <p class="rule-desc-content">2．复试通过者会有导演组进行电话通知，并确定拍摄时间。</p>
          <p class="rule-desc-title">五、活动免责协议 ：</p>
          ...
          <p class="rule-desc-content">7．参与本次活动涉及的消费，本公司只提供参与者在本公司的消费票据
          ...
          <p class="rule-desc-content">1．主办方开发H5页面作为此次活动的移动互联网平台。除耀强音传媒官方微信平台报名渠道外，任何以《闪耀之星》名义组织同类报名活动，均与主办方无关。请活动参与者注意识别，活动参与者在其他渠道如遭遇诈骗、欺诈等行为，请向司法机关举报，主办方均不承担任何责任。</p>
