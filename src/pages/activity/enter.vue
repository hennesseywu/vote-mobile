    ...
    <div v-if="ruleShow" class="rule">
      ...
      <div class="rule-pannel">
        ...
        <div class="rule-content">
          ...
          <p
            class="rule-desc-content"
          >3． 填写基本资料，如姓名、年龄，身份证号，联系手机等，并上传一段选手一分钟的才艺视频和一张选手照片。个人资料请一定保证真实，主办方有权取消个人信息不真实的报名选手资格；未满十八周岁参与必须在个人简介中填写其监护人真实联系方式和身份证号码。</p>
          ...
          <p
            class="rule-desc-content"
          >3．入选者将会收到短信通知、微信提醒或电话通知，官方媒体将公布每一阶段入围情况，请密切关注。更换预留电话的选手请及时通过微信咨询功能告知导演组或重新报名。</p>
          <p class="rule-desc-title">四、赛程时间 ：</p>
          <p
            class="rule-desc-content"
          >《闪耀之星》是由四川耀强音文化传媒有限公司作为承办方与成都广播电视台、谢家班明星舞蹈培训机构以及闪耀之星儿童艺术团联合主办的一档少儿选拔类节目。</p>
          ...
          <p
            class="rule-desc-content"
          >3．参与用户必须在线签订电子协议，凭借身份证和入选成功短信参加复试。不能提供有效证件或证件信息无法核实选手的，主办方有权取消其现场参赛资格。</p>
          ...
          <p
            class="rule-desc-content"
          >9．参与本次活动，须遵守现场秩序、活动规则和工作人员的指挥，活动参与者出现任何扰乱秩序和比赛公正性的行为，活动主办方有权剥夺其入场资格。</p>
          <p class="rule-desc-content">(2) 主办方免责条款 ：</p>
          <p
            class="rule-desc-content"
          >．主办方开发H5页面作为此次活动的移动互联网平台。除耀强音传媒官方微信平台报名渠道外，任何以《闪耀之星》名义组织同类报名活动，均与主办方无关。请活动参与者注意识别，活动参与者在其他渠道如遭遇诈骗、欺诈等行为，请向司法机关举报，主办方均不承担任何责任。</p>
          <p
            class="rule-desc-content"
          >2．本次活动期间如发生不可抗力导致活动不能正常进行的，主办方不承担任何责任。不可抗力是指不能控制不可预见或不能避免， 即使预见亦无法避免的事件，该事件使任何一方根据本协议履行其全部或部分义务已不可能。包括社会异常事件、自然灾害或政府管制行为而造成的网络关闭等非基于主办方过错的行为。</p>
          <p
            class="rule-desc-content"
          >3．鉴于互联网之特殊性质，活动期间若发生黑客攻击、电信部技术调整导致重大影响、病毒侵袭、网络故障、带宽、域名解析故障或其他网络设备或技术提供商的服务延迟、服务障碍或任何其他类似事件，致使活动无法正常进行，主办方因此免责。</p>
          <p
            class="rule-desc-content"
          >4．用户自身主观过错或恶意，如不按正常流程操作、填写信息不真实、不完整等类似情形致使此次申请无效、无法核验用户真实信息而不能正常参赛的，主办方不承担任何责任。</p>
          <p class="rule-desc-content">5．由于第三方网站通过技术手段恶意攻击或篡改致使申请发生错误，主办方不负任何法律或经济责任，信息数据主办方公示为准。</p>
          <p
            class="rule-desc-content"
          >6．主办方节目官方网站如因系统维护或升级而需暂停服务时，将事先公告。若因线路及硬件故障或其它不可抗力(含黑客攻击)而导致暂停服务，于暂停服务期间造成的一切不便与损失，主办方不承担任何责任。</p>
          <p class="rule-desc-content">(3) 用户隐私约定 ：</p>
          <p
            class="rule-desc-content"
          >1．本次活动要求活动参与者提供真实的个人资料，如:姓名、性别、身份证号码、手机号码、居住地点等，在未经活动参与者同意的情况下，主办方不会将参与者的个人信息提供给任何第三方。</p>
          <p
            class="rule-desc-content"
          >2．当政府司法机关依照法定程序要求主办方披露参与者个人资料时，我们将根据执法单位之要求或为公共安全之目的提供个人资料。在此情况下之任何披露，主办方均得免责。</p>
          <p class="rule-desc-content">3．由于用户将个人资料、证件转借或告知他人或与他人共享注册账户，由此导致的任何个人资料泄露，主办方不承担任何责任。</p>
          <p
            class="rule-desc-content"
          >4．任何由于网络问题、黑客攻击、计算机病毒侵入或发作、因政府管制而造成的暂时性关闭等影响网络正常运行的不可抗力而造成的个人资料泄露、丢失、被盗用或被篡改等，主办方均得免责。</p>
            ...
            <div class="photo">
              <form ref="imageForm1">
                ...
                <input
                  ...
                  class="file"
                  name="photo"
                  @change="onFile($event,'photo1','imageForm1')"
                >
              </form>
            </div>
            <div class="photo">
              <form ref="imageForm2">
                ...
                <input
                  ...
                  class="file"
                  name="photo"
                  @change="onFile($event,'photo2','imageForm2')"
                >
              </form>
            </div>
            <div class="photo">
              <form ref="imageForm3">
                ...
                <input
                  ...
                  class="file"
                  name="photo"
                  @change="onFile($event,'photo3','imageForm3')"
                >
              </form>
            </div>
            <div class="photo">
              <form ref="imageForm4">
                ...
                <input
                  ...
                  class="file"
                  name="photo"
                  @change="onFile($event,'photo4','imageForm4')"
                >
              </form>
            </div>
            <div class="photo">
              <form ref="imageForm5">
                ...
                <input
                  ...
                  class="file"
                  name="photo"
                  @change="onFile($event,'photo5','imageForm5')"
                >
              </form>
            </div>
          </div>
          ...
          <div class="video">
            <form ref="videoForm">
              ...
              <input
                ...
                ref="video"
                name="video"
                @change="onFile($event,'video','videoForm')"
              >
            </form>
          </div>
